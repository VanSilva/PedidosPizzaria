...
Route::group(['middleware'=> 'auth'], function() {
    ...
    Route::group(['prefix'=>'entregadores', 'where'=>['id'=>'[0-9]']], function() {
        ...
        Route::get('edit',         ['as'=>'entregadores.edit',    'uses'=>'EntregadoresController@edit'    ]);
    ...
    Route::group(['prefix'=>'pizzas', 'where'=>['id'=>'[0-9]']], function() {
        ...
        Route::get('edit',         ['as'=>'pizzas.edit',    'uses'=>'PizzasController@edit'    ]);
    ...
    Route::group(['prefix'=>'ingredientes', 'where'=>['id'=>'[0-9]']], function() {
        ...
        Route::get('edit',         ['as'=>'ingredientes.edit',    'uses'=>'IngredientesController@edit'    ]);
